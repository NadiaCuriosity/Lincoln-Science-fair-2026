# Lincoln's Bird Food Science Fair Coaching Guide

## Parent Role

The goal is to help Lincoln think like a scientist without doing the project for him.
...
- Same amount of solid food, for example 1/4 cup
- Same nectar recipe and fill line
- Fresh food at the start
...
Count **bird visits**, not individual birds. It is too hard to know whether the same bird comes back.
...
- What clue makes you think it is that bird?
- Are you sure, maybe sure, or unsure?
- What does the bird's size, colour, beak, movement, or feeding spot tell you?
...
| Bird | Clues |
|---|---|
| Silvereye/tauhou | Small, green-grey, white eye ring, often likes fruit and nectar |
| Tui | Larger, dark body, white throat tufts, often interested in nectar |
| Sparrow | Small brown/grey bird, often lower, often interested in grains |
| Chaffinch | Small introduced finch, colourful male, often seed-eating |
| Greenfinch | Stockier greenish finch, often seed-eating |

Closer videos will help. A still image from the video can go into Canva with arrows and labels.
...
- How might height or location have changed the results?
- What would you change next time?
- What would you do differently if you had better cameras or more time?
...
- Add Lincoln's name.
- Add one photo of the setup.

### Question

- Use the final question.
- Show the independent variable and dependent variable.
...
Lincoln can research:

- What do common backyard birds eat?
- Which NZ birds drink nectar?
- Why do some birds feed higher up and some lower down?
- How can feeding birds safely be done?
...
> Same time of day, same recording length, same amount of food, fresh food, same backyard, people stay away.

### Hypothesis

Lincoln writes his own prediction.
...
- Setup photo with labels
- Close-up of each station
- Video stills of birds if possible

### Results

Use the tally table and final totals.
...
Answer the question using results.

### Discussion

Explain what the results might mean.

### Evaluation

Explain what worked, what was hard, and what he would change.
...
| Term | Definition |
|---|---|
| Independent variable | The thing I changed |
| Dependent variable | The thing I measured |
| Controlled variable | The thing I kept the same |
| Hypothesis | My prediction |
| Bird visit | A bird landing on or feeding from a station |
| Native bird | A bird that naturally belongs in New Zealand |
| Introduced bird | A bird brought to New Zealand by people |

## Safety And Care Notes

- Keep food amounts small.
- Clean nectar feeders.
- Remove leftover food after the trial.
- Do not leave spoiled food out.
- Keep pets away during recording.
- Do not use foods that are unsafe for birds.
